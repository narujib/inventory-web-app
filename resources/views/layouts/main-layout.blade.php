...
data-template="vertical-menu-template-free">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('sneat-bootstrap-free/vendor/libs/apex-charts/apex-charts.css') }}" />
    ...
    <body>
        ...
        <!-- Vendors JS -->
        <script src="{{ asset('sneat-bootstrap-free/vendor/libs/apex-charts/apexcharts.js') }}"></script>
