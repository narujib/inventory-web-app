...
<body>
  <div>
    <div class="py-10">
      <div>
        <table class="w-full mb-10 border-collapse border-spacing-0" style="margin-bottom: 10px">
          <tbody>
            <tr>
              <td class="w-full align-top" align="center">
                <div>
                  {{-- <img src="{{ asset('storage/avatars/default.png') }}" class="h-12" /> --}}
                  <p><h1 class="font-bold" style="margin-top: 10px">Inventory Web App</h1></p>
                </div>
              </td>
            </tr>
          </tbody>
      ...
      <div class="bg-slate-100 px-5 text-sm py-1">
      ...
      <div class="px-5 text-sm text-neutral-700 py-3" >
        <table class="w-full border-collapse border-spacing-0" align="center">
          <thead>
            <tr>
